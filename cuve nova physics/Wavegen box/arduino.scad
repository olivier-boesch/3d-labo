 ...
 *
 * Added placement module for mounting holes : olivier Boesch 2022
 *
...
Arduino();
place_on_MountingHoles() cylinder(d=2, h=10);
...
module place_on_MountingHoles()
{
	children();
	translate([-1.0929112, -48.4026972, 0]) children();;
	translate([51, -15.25, 0]) children();
	translate([51, -43.25, 0]) children();
}
